...
I tried to change the password hash in the system dump and tried flashing it using fastboot, this sadly resulted in a perma brick. (it refused to accept both a T10 and a T9 sys image)
